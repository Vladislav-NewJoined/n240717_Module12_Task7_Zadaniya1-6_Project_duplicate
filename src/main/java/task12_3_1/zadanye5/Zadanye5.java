...
// Запрос для выборки четных записей
            String selectEvenQuery = "SELECT employee_id, first_name, last_name, hire_date FROM Users WHERE MOD(employee_id, 2) = 0";
            ResultSet rs = stmt.executeQuery(selectEvenQuery);
