...
public class Zadanye3_5 {
    ...
    public static void main(String[] args) {
        System.out.println("""
            ...
            Решение (при каждом последующем запуске кода
                    перезагрузите соединение с базой данных somedbPostgres, т.е. нажмите
                    'disconnect' и затем 'connect' в блоке 'DB Browser' внутри 'IntelliJ IDEA'):
            """);
